...
export default function Home() {
  return (
    <main>
      <div>
        <div className="p-20 flex flex-col bg-[#1a191e] dark:bg-slate-800 text-white space-y-10 items-center justify-center">
          <Link href="https://github.com/dayyan-aly/dropbox_clone" className="flex cursor-pointer bg-blue-500 p-1 rounded-full w-fit text-white text-sm font-bold items-center justify-center space-x-2 px-4 py-2 underline text-center">
